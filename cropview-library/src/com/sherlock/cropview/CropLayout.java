...
public class CropLayout extends FrameLayout {
	...
	private void setup(Context context) {
		...
		FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mProgressBar
				.getLayoutParams();
	...
	private void notifyDisplay() {
		if (mOriginalBitmap != null) {
			mCropView.initialize(mOriginalBitmap, mCropRect, mRotation);
		}
	}
	...
	private void perfromCropSuccess(Uri data) {
		if (mOnCropListener != null) {
			mOnCropListener.onCropSuccess(data);
		}
	}
